  ...
  const go = async () => {
    ...
    try {
      ...
      if (e.name === 'NotAllowedError') {
        useUI.getState().toast(t('Passkey creation was cancelled or not allowed'))
...
export default function Login() {
  ...
  const signIn = async () => {
    try {
      ...
      if (e.name === 'NotAllowedError') {
        useUI.getState().toast(t('No passkey selected or found. Create a profile below to get started.'))
      } else if (e.name !== 'AbortError') {
